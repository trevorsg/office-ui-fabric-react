...
const data: IFullDocumentCardProps[] = [
  {
    ...
    documentActivityProps: {
      ...
      people:
      [
        { name: 'Kat Larrson', profileImageSrc: '/Modules/DevOffice.Fabric/dist/images/avatar-kat.png' },
        { name: 'Josh Hancock', profileImageSrc: '', initials: 'JH' },
        { name: 'Tina Dasani', profileImageSrc: '/Modules/DevOffice.Fabric/dist/images/avatar-kat.png' }
      ]
    },
    documentTitleProps: {
      title: 'Document1',
